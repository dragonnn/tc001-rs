...
use crate::{Ds1307, async_api::AsyncRtc, registers::Register};
...
mod tests {
    ...
    fn test_get_datetime_24h_mode() {
        ...
        let expectations = [I2cTrans::write_read(0x68, vec![Register::Seconds.addr()], data.to_vec())];
    ...
    fn test_set_datetime_invalid_year() {
        ...
        assert!(matches!(result, Err(crate::error::Error::DateTime(DateTimeError::InvalidYear))));
